...
import com.bookaholic.account.DeliciousAccount;

/**
 * Base a activity which handles making sure that the user has added an account
 * and if necessary asking the user to do so.
 */
public abstract class BaseActivity extends FragmentActivity {
	...
	/**
	 * Called if the account changes after launch, for example if a user is
	 * asked to login and does so.
	 */
