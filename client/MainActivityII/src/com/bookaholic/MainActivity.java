...
import com.bookaholic.contenthandlers.ContentHandlerLogcat;
...
public class MainActivity extends Activity {
	...
	private void prepareToPageLoad() {
		...
		Toast.makeText(getApplicationContext(), "Started to prepare load page",
				Toast.LENGTH_LONG).show();
		cl = new Client();
		com.libraryclient.config.Connection.CONNECTION_WEBSITE = "http://localhost:8080/";
		...
		class LoadPagesTask extends AsyncTask<Request, Integer, Boolean> {
			...
			protected void onPostExecute(Boolean result) {
				Toast.makeText(getApplicationContext(),
						"Downloaded " + result + " bytes", Toast.LENGTH_LONG)
						.show();
			}
		}
	...
	private void loadMenu() {
		...
		int[] groupIconId = { R.drawable.ic_menu_group,
				R.drawable.ic_menu_group, R.drawable.ic_menu_group,
