...
import com.bookaholic.cards.TitleDescCard;
...
public class BrowseBooks extends Fragment implements OnClickListener {
	...
	public void onCreate(Bundle outState) {
		...
		if (DEBUG)
			Log.v(TAG, "SYATE : Frag_BrowseBooks : onCreate : bundle = "
					+ outState);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewRoot = inflater.inflate(R.layout.frag_browse_books, container,
				false);
		...
		mTabsAdapter.addTab(
				mTabHost.newTabSpec("newbooks").setIndicator("New"),
				NewBooks.class, null);
		mTabsAdapter.addTab(
				mTabHost.newTabSpec("topbooks").setIndicator("Top Rating"),
