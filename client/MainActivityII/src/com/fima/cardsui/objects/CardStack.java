...
public class CardStack extends AbstractCard
{
	...
	/***** start: StackPositionConstants *****/
	public static final int STACK_POS_TYPE_LEFT_TOP = 1;
	public static final int STACK_POS_TYPE_TOP = 2;
	public static final int STACK_POS_TYPE_RIGHT_TOP = 3;
	public static final int STACK_POS_TYPE_LEFT_MIDDLE = 4;
	public static final int STACK_POS_TYPE_MIDDLE = 5;
	public static final int STACK_POS_TYPE_RIGHT_MIDDLE = 6;
