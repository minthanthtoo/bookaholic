...
import com.navdrawer.*;
import com.testbuild.fragments.*;
import com.testbuild.global.*;
import com.testbuild.menu.*;
import java.util.*;

import android.view.View.OnClickListener;
import com.testbuild.menu.MenuItem;

public class MainActivityII extends FragmentActivity implements
OnItemClickListener, OnBackStackChangedListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		ArrayList<com.testbuild.menu.MenuItem> menus = new ArrayList<MenuItem>();
	...
	public void onBackPressed()
	{
		...
		{
			currentContentFragmentTag = FragmentManager.getBackStackEntryAt(i - 2).getName();
	...
	private void initialize()
	{
		...
		getSharedPreferences(Preferences.Login.PREF_NAME, Preferences.Login.PREF_MODE);
		...
		Boolean isLoggedin=prefs.getBoolean(Preferences.Login.IS_LOGGED_IN,false);
		String pass=prefs.getString(Preferences.Login.LAST_USER_PASSWORD,null);// TODO: security implementation is required

		if(remote==null){
			remote=getResources().getString(R.string.default_login_remoteBackEnd);
...
//		get
	...
	public static void updateContent(Uri uri)
	{
		...
		if (uri.getQuery() != null)
		{
			...
			String[][] s = com.testbuild.utils.URI.queryToArrays(uri);
							...
							long id)
	{
		...
		nav.closeLeftSide();
		this.updateContent(Uri.parse(mMenuItemTypes[position]));
	}
