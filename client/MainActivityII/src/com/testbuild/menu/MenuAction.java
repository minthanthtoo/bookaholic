...
public class MenuAction  extends MenuItem
{
	...
	private String TAG = MenuCategory.class.getSimpleName();

	private boolean DEBUG = false;

	public MenuAction(String mName)
	{
		this.mTitle = mName;
		this.mImageId = 0;
	}

	public MenuAction(String mTitle, int mImageId)
	{
		this.mTitle = mTitle;
...
//
	...
	{
		if(container==null){
			container = LayoutInflater.from(context).inflate(R.layout.menu_list_child_item , vg , false);
			if(DEBUG)
